...
<div className="container-fluid mt-3">
 {
  ...
  allCategories?.map(categoryDetails=>(
    <div droppable="true" onDragOver={e=>dragOverCategory(e)} onDrop={e=>videoDropOverCategory(e,categoryDetails?.id)} key={categoryDetails?.id} className="border rounded p-3 mb-2">
...
<VideoCard displayData={video} insideCategory={true}/>
  ...
  :
  <div className='text-danger fw-bolder'>No Categories Addedd Yet!!!</div>
 }
</div>
